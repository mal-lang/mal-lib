...
import static org.mal_lang.test.lib.AssertAST.assertAssociation;
import static org.mal_lang.test.lib.AssertAST.assertCategory;
import static org.mal_lang.test.lib.AssertAST.assertDefine;
import static org.mal_lang.test.lib.AssertAST.assertEmptyAST;
import static org.mal_lang.test.lib.AssertAST.assertGetASTClassPath;
...
import org.mal_lang.lib.AST;
import org.mal_lang.lib.AST.ID;
import org.mal_lang.lib.Position;
    ...
    assertCategory(
        new AST.Category(
            ...
            Arrays.asList(
                ...
                new AST.Asset(
                    ...
                    Arrays.asList(
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.EXIST,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 49, 7), "a"),
                            List.of(),
                            Optional.empty(),
                            Optional.empty(),
                            Arrays.asList(),
                ...
                new AST.Asset(
                    ...
                    Arrays.asList(
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.ALL,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 61, 7), "a"),
                            List.of(),
                        ...
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.ANY,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 67, 7), "b"),
                            List.of(),
                            Optional.empty(),
                            Optional.empty(),
                            Arrays.asList(),
                        ...
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.DEFENSE,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 70, 7), "c"),
                            List.of(),
                            Optional.empty(),
                            Optional.of(
                                new AST.TTCFuncExpr(
                        ...
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.EXIST,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 73, 7), "d"),
                            List.of(),
                            Optional.of(Arrays.asList(AST.CIA.C)),
                            Optional.of(
                                new AST.TTCFuncExpr(
                            ...
                            Arrays.asList(
                                new AST.Meta(
                                    ...
                                    new ID(new Position(ATTACKSTEPS_MAL, 74, 7), "user"),
                                    "Info")),
                            Optional.of(
                                new AST.Requires(
                                ...
                                new AST.Reaches(
                                    ...
                                    Arrays.asList(
                                        new AST.IDExpr(
                                            ...
                                            new AST.ID(
                                                new Position(ATTACKSTEPS_MAL, 76, 10), "y"))))))),
                    List.of(
                        new AST.Variable(
                ...
                new AST.Asset(
                    new Position(ATTACKSTEPS_MAL, 80, 3),
                    false,
                    new AST.ID(new Position(ATTACKSTEPS_MAL, 80, 9), "A6"),
                    Optional.empty(),
                    List.of(),
                    List.of(
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.ANY,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 81, 7), "a"),
                            List.of(new AST.ID(new Position(ATTACKSTEPS_MAL, 81, 10), "a")),
                            Optional.empty(),
                            Optional.empty(),
                            List.of(),
                            Optional.empty(),
                        ...
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.ANY,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 82, 7), "b"),
                            List.of(new AST.ID(new Position(ATTACKSTEPS_MAL, 82, 10), "a")),
                        ...
                        new AST.AttackStep(
                            ...
                            AST.AttackStepType.ANY,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 83, 7), "c"),
                            List.of(
                            ...
                            Optional.empty()),
                        new AST.AttackStep(
                            new Position(ATTACKSTEPS_MAL, 84, 5),
                            AST.AttackStepType.ANY,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 84, 7), "d"),
                            List.of(
                                new AST.ID(new Position(ATTACKSTEPS_MAL, 84, 10), "a"),
                                new AST.ID(new Position(ATTACKSTEPS_MAL, 84, 13), "b")),
                            Optional.empty(),
                            Optional.of(
                                new AST.TTCFuncExpr(
                                    new Position(ATTACKSTEPS_MAL, 84, 16),
                                    new AST.ID(new Position(ATTACKSTEPS_MAL, 84, 16), "t"),
                                    List.of())),
                            List.of(),
                            Optional.empty(),
                            Optional.empty()),
                        new AST.AttackStep(
                            new Position(ATTACKSTEPS_MAL, 85, 5),
                            AST.AttackStepType.ANY,
                            new AST.ID(new Position(ATTACKSTEPS_MAL, 85, 7), "e"),
                            List.of(
                                new AST.ID(new Position(ATTACKSTEPS_MAL, 85, 10), "a"),
                                new AST.ID(new Position(ATTACKSTEPS_MAL, 85, 13), "b"),
                                new AST.ID(new Position(ATTACKSTEPS_MAL, 85, 16), "c")),
                            Optional.of(List.of(AST.CIA.C)),
                            Optional.of(
                                new AST.TTCFuncExpr(
                                    new Position(ATTACKSTEPS_MAL, 85, 23),
                                    new AST.ID(new Position(ATTACKSTEPS_MAL, 85, 23), "t"),
                                    List.of())),
                            List.of(),
                            Optional.empty(),
                            Optional.empty())),
